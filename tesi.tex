...
\hypersetup{
    ...
    pdftitle={Machine learning per lo studio del groove musicale: un primo approccio},    % title
    pdfauthor={Luca Greggio},     % author
    pdfsubject={Machine learning groove},   % subject of the document
    pdfcreator={Luca Greggio},   % creator of the document
    pdfproducer={Luca Greggio}, % producer of the document
    pdfkeywords={Machine learning per lo studio del groove musicale: un primo approccio}, % list of keywords
...
\begin{titlepage}
	...
	\vspace*{10mm}
	\Huge \emph{\textbf{Machine learning per lo studio del groove musicale: un primo approccio}}
	\vspace*{10mm}
	...
	\begin{minipage}{0.45\textwidth}
		\begin{flushleft} \Large
			\emph{Relatore:}\\
			\Large \textbf{Prof. Luciano \textsc{Fadiga}}
		\end{flushleft}
	\end{minipage}
	\begin{minipage}{0.45\textwidth}
